...
3-	Créer une Nouvelle Application sur Heroku
Se connecter à Heroku via la CLI : heroku login
Créez une nouvelle application dans le site Heroku car si je crée via la ligne de commande, l’application se crée directement en zone ‘US’. Hors, je veux que mon application soit créé en zone « Europe ».

4-	Utiliser JAWSDB comme Base de données pour Heroku
Heroku addons :create jawsdb

5-	Déployer l'Application
Poussez votre code vers Heroku : git push heroku master
